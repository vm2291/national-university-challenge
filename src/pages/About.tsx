  ...
  return (
    <div className="min-h-screen pt-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="flex justify-center mb-6">
              <BookOpen className="w-16 h-16 text-[#a86b3e]" />
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center">
              <h2 className="text-4xl sm:text-5xl font-bold mb-6 bg-gradient-to-r from-[#a86b3e] via-[#7a4520] to-[#3d2515] bg-clip-text text-transparent">
            ...
            <Card className="p-10 bg-muted/20 border-secondary/30">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <Calendar className="w-8 h-8 text-[#a86b3e] flex-shrink-0" />
                  <div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            <h2 className="text-4xl sm:text-5xl font-bold text-center bg-gradient-to-r from-[#a86b3e] via-[#7a4520] to-[#3d2515] bg-clip-text text-transparent">
              2024 Event Highlights
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="p-8 bg-card border-border">
                <Users className="w-10 h-10 text-[#a86b3e] mb-4" />
              ...
              <Card className="p-8 bg-card border-border">
                <Award className="w-10 h-10 text-[#a86b3e] mb-4" />
      ...
      <section className="py-20 bg-card/40 text-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="pt-8">
              <p className="text-2xl font-bold text-[#a86b3e]">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <Card className="p-10 bg-card border-secondary/30 shadow-xl">
              <div className="space-y-4">
                ...
                <p className="text-xl text-[#a86b3e] font-semibold">
