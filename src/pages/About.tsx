  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl sm:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-[#5a2a14] via-[#5a2a14] to-[#3d1a08] bg-clip-text text-transparent">
            What Drives Us
          </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center">
              <h2 className="text-4xl sm:text-5xl font-bold mb-6 bg-gradient-to-r from-[#5a2a14] via-[#5a2a14] to-[#3d1a08] bg-clip-text text-transparent">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center space-y-6">
              <h2 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-[#5a2a14] via-[#5a2a14] to-[#3d1a08] bg-clip-text text-transparent">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            <h2 className="text-4xl sm:text-5xl font-bold text-center bg-gradient-to-r from-[#5a2a14] via-[#5a2a14] to-[#3d1a08] bg-clip-text text-transparent">
              2024 Event Highlights
            </h2>
