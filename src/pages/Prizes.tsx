        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            <div className="flex justify-center mb-6">
              <Trophy className="w-16 h-16 text-[#a86b3e]" />
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl sm:text-3xl font-bold text-center bg-gradient-to-r from-[#a86b3e] via-[#7a4520] to-[#3d2515] bg-clip-text text-transparent">
                  ...
                  <Card key={index} className="overflow-hidden bg-card border-secondary/20 hover:border-secondary/40 transition-all duration-300 hover:shadow-xl hover:shadow-secondary/10">
                    ...
                    <div className="p-6">
                      <div className="flex items-center gap-3 mb-2">
                        <Gift className="w-5 h-5 text-[#a86b3e]" />
                  ...
                  <Card key={index} className="overflow-hidden bg-card border-secondary/20 hover:border-secondary/40 transition-all duration-300 hover:shadow-xl hover:shadow-secondary/10">
                    ...
                    <div className="p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Award className="w-4 h-4 text-[#a86b3e]" />
            ...
            <Card className="p-8 bg-muted/20 border-secondary/30">
              <div className="flex items-start gap-4">
                <Award className="w-8 h-8 text-[#a86b3e] flex-shrink-0 mt-1" />
