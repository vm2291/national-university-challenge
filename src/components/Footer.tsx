const Footer = () => {
  return (
    <footer className="py-12 bg-primary text-primary-foreground border-t border-primary/30 mt-auto">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-sm font-semibold text-primary-foreground/95 mb-1">
                Dr. Dania Zantout
              </p>
          ...
          <div className="border-t border-primary-foreground/20 pt-6 mt-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-xs text-primary-foreground/70 text-center md:text-left">
                © 2025 Takāmul Cup. All rights reserved.
              </p>
              <p className="text-xs text-primary-foreground/70 text-center md:text-right">
